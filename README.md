...
```bash
    kill -9 <PID>
```
![App Screenshot]([https://via.placeholder.com/468x300?text=App+Screenshot+Here](https://github.com/esmaozbalta/Portfolio-website/blob/main/screenshots/index.png))
